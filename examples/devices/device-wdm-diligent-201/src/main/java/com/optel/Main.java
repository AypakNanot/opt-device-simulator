...
public class Main {
    ...
    private static final String JAR_NAME = "wdm-diligent-201-22.2.0-SNAPSHOT.jar";
    ...
    public void start(String[] args, boolean registerShutdownHook) {
        ...
        Namespace parseArguments = new ArgumentParser().parseArguments(args);
        ...
        LOG.info(String.format("Load module size: %d\nLoad processor size: %d", models.size(), processors.size()));
