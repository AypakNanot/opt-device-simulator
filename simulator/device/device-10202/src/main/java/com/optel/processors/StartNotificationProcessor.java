...
import org.opendaylight.yang.gen.v1.urn.cmcc.yang.rpc.rev230426.StartNotification;
import org.opendaylight.yang.gen.v1.urn.cmcc.yang.rpc.rev230426.StartNotificationInput;
import org.opendaylight.yang.gen.v1.urn.cmcc.yang.rpc.rev230426.StartNotificationOutput;
...
public class StartNotificationProcessor extends ToasterServiceAbstractProcessor<StartNotificationInput,
    ...
    private static final Logger LOG = LoggerFactory.getLogger(StartNotificationProcessor.class);

    private final ToasterServiceImpl toasterService;
    private final QName qName = QName.create("urn:cmcc:yang:rpc", "start-notification");
